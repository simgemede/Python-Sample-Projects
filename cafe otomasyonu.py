...
labelYemek = tk.Label(frame1,text="Türk Kahvesi..... 15 TL",fg="black",bg="light gray",font=("Lucida Calligraphy",13,"bold"))
labelYemek.place(x=25,y=80)
labelYemek = tk.Label(frame1,text="Sütlü Kahve...... 17 TL",fg="black",bg="light gray",font=("Lucida Calligraphy",13,"bold"))
labelYemek.place(x=25,y=110)
labelYemek = tk.Label(frame1,text="Filtre Kahve..... 15 TL",fg="black",bg="light gray",font=("Lucida Calligraphy",13,"bold"))
labelYemek.place(x=25,y=140)
labelYemek = tk.Label(frame1,text="......................................",fg="black",bg="light gray",font=("Lucida Calligraphy",13,"bold"))
labelYemek.place(x=25,y=170)
labelYemek = tk.Label(frame1,text="Limonata.......... 17 TL",fg="black",bg="light gray",font=("Lucida Calligraphy",13,"bold"))
labelYemek.place(x=25,y=200)
labelYemek = tk.Label(frame1,text="Kola.................. 15 TL",fg="black",bg="light gray",font=("Lucida Calligraphy",13,"bold"))
labelYemek.place(x=25,y=230)
labelYemek = tk.Label(frame1,text="Gazoz................ 10 TL",fg="black",bg="light gray",font=("Lucida Calligraphy",13,"bold"))
labelYemek.place(x=25,y=260)
labelYemek = tk.Label(frame1,text="Su...................... 3,5 TL",fg="black",bg="light gray",font=("Lucida Calligraphy",13,"bold"))
labelYemek.place(x=25,y=290)
